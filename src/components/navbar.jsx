export default function Navbar() {
    return (
        <section className="navbar">
            ...
            <nav>
                <svg fill="currentColor" width="24" height="24" viewBox="0 0 24 24" id="menu" data-name="Flat Line" xmlns="http://www.w3.org/2000/svg" className="icon flat-line"><path id="primary" d="M3,12H21M9,18H21M3,6H15" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5"></path></svg>
